...
- bom candidato a relay e a âncora de sincronização local.
...
- PC pode ser nó estável, relay, anchor e observer, mas não vira autoridade semântica por isso.
